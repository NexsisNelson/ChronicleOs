      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-300 mb-8">
            A developer dashboard for long-running AI workflows powered by Walrus and MemWal
          </p>
          <Link
            href="/dashboard"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <FeatureCard
            ...
            description="Watch your agents think. See every state change, decision, and reasoning step across hours or days of execution."
          />
          <FeatureCard
            icon={<FileStack className="w-6 h-6" />}
            title="Artifact Explorer"
            description="Browse all files generated by agents: reports, datasets, code, and execution logs stored on Walrus."
          />
          <FeatureCard
            icon={<Zap className="w-6 h-6" />}
            title="Live Agent Monitor"
            description="Monitor agent status, track current task, view logs, and debug issues in real-time."
          />
        </div>
